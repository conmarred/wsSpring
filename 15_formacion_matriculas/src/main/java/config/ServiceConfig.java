...
//anotacion especifica para jpa
//sirve para decirle a spring donde estan las interfaces que tiene que instanciar
...
public class ServiceConfig {
	...
	//Aquí ya no hay jdbcTemplate, el datasource si se necesita para la persistencia
