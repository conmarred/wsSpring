...
public class FormacionServiceImpl implements FormacionService{
	...
	public boolean altaAlumno(Alumno alumno) {
		Optional<Alumno> aux = alumnosDao.findById(alumno.getUsuario());
		if(!aux.isPresent()) {
...
//		}
	...
	@Override
	public List<Curso> findCursosFechaBetween(Date first, Date second) {
		return cursosDao.findByFechaBetween(first, second);
	}
	@Override
